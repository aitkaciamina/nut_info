...
<body>
    ...
    <?php
         ...
         function afficherQuestions($pdo)
         {
             ...
             $requete = $pdo->prepare("SELECT * FROM QCM_Principal");
        ...
        {    
            ...
            $requete = $pdo->prepare("SELECT COUNT(*) FROM QCM_Principal");
            ...
            while ($correct and !$pasRepondu and $id < $nombresQuestions)
            {
                 ...
                 {
                    $requete = $pdo->prepare("SELECT * FROM QCM_Principal WHERE id_question = :id");
